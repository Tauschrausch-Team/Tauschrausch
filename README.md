...
Installieren Sie die Software **Git** von der Seite https://git-scm.com/download/win. Starten Sie die Konsole (`Win+R` -> `cmd`) und klonen Sie dieses Repository mit dem folgenden Befehl: `git clone https://github.com/Tauschrausch-Team/Tauschrausch`. Geben Sie ihre Zugangsdaten ein, wenn Sie dazu aufgefordert werden.
